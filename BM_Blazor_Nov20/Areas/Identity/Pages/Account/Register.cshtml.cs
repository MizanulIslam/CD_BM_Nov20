...
namespace BM_Blazor_Nov20.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            ExternalLogins = (await _signInManager.GetExternalAuthenticationSchemesAsync()).ToList();
            var connnectionStringGuid = Guid.NewGuid();
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser
                {
                    ...
                    ConnectionString = connnectionStringGuid.ToString(),
                };
                ...
                var resultFind = await _userManager.FindByEmailAsync(user.Email);
                if (resultFind == null)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        var resultClient = await _clientListDbContext.Clients.AddAsync(objClient);
